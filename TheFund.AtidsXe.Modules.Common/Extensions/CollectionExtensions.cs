...
namespace TheFund.AtidsXe.Modules.Common.Extensions
{
    public static class CollectionExtensions
    {
        ...
        public static bool IsEmpty([NotNull] this ICollection collection)
        {
        ...
        /// <param name="collection">The collection to test.</param>
        /// <returns>True if the collection is empty.</returns>
        public static bool IsEmpty([NotNull] this IList collection)
        {
            if (collection == null) throw new ArgumentNullException(nameof(collection));
            return collection.Count == 0;
        }
        ...
        /// <param name="collection">The collection to test.</param>
        /// <returns>True if the collection is empty.</returns>
        public static bool IsEmpty<T>([NotNull] this IList<T> collection)
        {
            if (collection == null) throw new ArgumentNullException(nameof(collection));
            return collection.Count == 0;
        }
